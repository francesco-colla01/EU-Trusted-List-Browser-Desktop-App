...
public class Tsp {
    ...
    private String countryCode, name, trustmark, jsonFormat;
    private int tspId;
    private String[] serviceTypes;
    private Services[] services;

    public Tsp(String jsonSource) {
        ...
        services = new Services[jsonServices.length()];
        for (int i=0; i<jsonServices.length(); i++) {
            services[i] = new Services(jsonServices.getJSONObject(i).toString());
        }
    }
